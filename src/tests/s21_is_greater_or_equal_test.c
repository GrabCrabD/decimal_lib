...
Suite *s21_is_greater_or_equal_suite_create(void) {
  ...
  tcase_add_test(tcase_core, s21_is_greater_or_equal_1);
  tcase_add_test(tcase_core, s21_is_greater_or_equal_2);
  tcase_add_test(tcase_core, s21_is_greater_or_equal_3);
  tcase_add_test(tcase_core, s21_is_greater_or_equal_4);
  tcase_add_test(tcase_core, s21_is_greater_or_equal_5);
  tcase_add_test(tcase_core, s21_is_greater_or_equal_6);
  tcase_add_test(tcase_core, s21_is_greater_or_equal_7);
